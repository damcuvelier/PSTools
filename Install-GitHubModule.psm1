...
if(test-path "$here\CMScripts-$Name" -ErrorAction silentlycontinue){
	Copy-Item "$here\CMScripts-$Name\$Name.psm1" -Destination $here -force
	Remove-Item "$here\CMScripts-$Name" -Recurse -Force -Confirm:$false | out-null
}
}
